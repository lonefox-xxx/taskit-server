...
async function TurnOffChannelsAndGroups(req, res) {
    try {
        ...
        await db.updateLog({ id, data: { status: 0 } }, 'associatedChannelsAndGroups', false)
...
module.exports = TurnOffChannelsAndGroups;